    ...
    public class PdfExtractor_Beckers : IPdfExtractorService
    {
        public VibImport ExtractData(string filePath)
        {
            ...
            var result = new VibImport
            {
                ...
                H_Cat = hCats,
                Adr_Un_Nr = unNummer,
                Adr_CargoName = ladingNaam,
                Adr_TransportHazardClass = gevarenKlasse,
                Adr_PackagingGroup = verpakkingsGroep,
                Adr_EnvironmentHazards = milieugevaren,
                Adr_ExtraInfo = "",
                Imdg_UnNumber = Imdg_unNummer,
                Imdg_CargoName = Imdg_ladingNaam,
                Imdg_TransportHazardClass = Imdg_gevarenKlasse,
